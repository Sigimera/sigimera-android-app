...
public class StatisticCrisesHttpHelper extends AsyncTask<String, Void, JSONObject> {

    private final String HOST = Config.getInstance().getAPIHost()+"/stats/crises.json?auth_token=";
